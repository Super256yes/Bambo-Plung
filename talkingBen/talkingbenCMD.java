...
/*    */ 
/*    */ public class talkingbenCMD implements CommandExecutor {
...
/* 18 */     if (command.getName().equalsIgnoreCase("ben")) {
/* 19 */       if (player.isOp()) {
/* 20 */         sender.sendMessage(ChatColor.GREEN + "Gave item to the player!");
/* 21 */         player.getInventory().addItem(new ItemStack[] { Item.Talkingben });
/*    */       } else {
/*    */         
...
/* Location:              C:\Users\nikor\Downloads\Bambo-Plugin.jar!\bamboplugin\bamboplugin\talkingBen\talkingbenCMD.class
